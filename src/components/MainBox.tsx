    ...
    <div className="bg-[#70707082] w-auto h-auto rounded-xl p-5">
      <div className="flex mx-10">
        <Input
          ...
          className="bg-white mx-5"
          placeholder="Enter Country"
        />
        <Button onClick={() => SearchCountry(search)} className="bg-[#1B7E94]">
          Search
        </Button>
      </div>
      <div className="min-h-[100%] grid grid-cols-1 grid-rows-1 md:grid-cols-3 md:grid-rows-2 gap-4 p-5">
        ...
        <div className="md:col-start-2 md:row-start-2">
          <MainCard
            ...
            weatherComponent={
              <Recent
                recent={getRecentStorage().map((names: string, idx: number) => {
                  return (
                    <div key={idx} className="flex justify-between">
                      <p
                        className="text-xl font-bold"
                        onClick={() => SearchCountry(names)}
                      >
                        {names}
                      </p>
                    </div>
        ...
        <div className="md:col-start-3 md:row-start-2">
          <MainCard
            ...
            weatherComponent={
              <SavedBox
                saved={getLocalStorage().map((names: string, idx: number) => {
                  return (
                    <div key={idx} className="flex justify-between">
                      <p
                        className="text-xl font-bold"
